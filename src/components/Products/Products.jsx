...
class Products extends Component {
  ...
  onChangeStatus = (confirm, status, id, idx) => {
    if (confirm) {
      ...
      this._productModel.changeStatus(id, postData)
      .then(() => {
  ...
  handleExport = () => {
    this._productModel.exportExcel()
    .then(response => {
      ...
      },
      {
        ...
        options: {
          ...
          customBodyRender: (value, tableMeta, updateValue) => {
            return (
                (1 * this.state.data[tableMeta['rowIndex']].is_service) === 1 ? "" : <span>{this.state.data[tableMeta['rowIndex']].origin_name}</span>
            );
          }
        }
      },
                ...
                <CheckAccess permission="MD_PRODUCT_EDIT">
                  <FormControlLabel
                    ...
                    onChange={event => {
                      ...
                      this.handleChangeStatus(checked, this.state.data[tableMeta['rowIndex']].product_id, tableMeta['rowIndex'])
                    }}
              ...
              <div className="text-center">
                ...
                <CheckAccess permission="MD_PRODUCT_DEL">
                  <Button
                    ...
                    title="Xóa"
                    className=""
                    onClick={evt => this.handleActionItemClick('delete', this.state.data[tableMeta['rowIndex']].product_id, tableMeta['rowIndex'])}
      ...
      <div className="animated fadeIn">
        ...
        {!handlePick ? (<div>
          ...
          <CheckAccess permission="MD_PRODUCT_IMPORT">
            <Button className="col-12 max-w-110 mb-2 mr-2 mobile-reset-width" onClick={() => this.handleToggleImportExcel()} color="excel"  size="sm">
              <i className="fa fa-upload mr-1" />Nhập excel
            </Button>
          </CheckAccess>
          <CheckAccess permission="MD_PRODUCT_EXPORT">
            <Button className="col-12 max-w-110 mb-2  mr-2  mobile-reset-width" onClick={() => this.handleExport()} color="excel"  size="sm">
